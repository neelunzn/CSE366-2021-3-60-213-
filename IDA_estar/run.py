...
def main():
    ...
    while running:
        ...
        # In run.py, in the display status panel section:
        ...
        # Create the completed tasks text with costs
        if agent.completed_tasks:
            ...
            if len(completed_tasks_str) > 30:  # Threshold for breaking into multiple lines
                completed_parts = []
                current_part = []
        ...
        # Handle multi-line completed tasks display
